            ...
            {partners.map((partner, index) => (
              ...
              >
                <div className="text-center">
                  <div className="text-4xl md:text-5xl font-orbitron font-bold text-white/70 group-hover:text-icd-blue transition-colors duration-300">
                    {partner.letter}
                  </div>
                  <div className="mt-2 font-robotomono text-white/50 group-hover:text-white/90 transition-colors duration-300">
                    {partner.name}
                  </div>
                </div>
              </div>
